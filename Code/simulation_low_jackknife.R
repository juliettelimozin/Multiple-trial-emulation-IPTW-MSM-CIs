...
save(CI_bootstrap_PP_red, file = paste("NewSimusJ/J_CI_bootstrap_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_sandwich_PP_red, file = paste("NewSimusJ/J_CI_sandwich_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_PP_red, file = paste("NewSimusJ/J_CI_LEF_outcome_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_PP_red, file = paste("NewSimusJ/J_CI_LEF_both_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_jackknife_mvn_PP_red, file = paste("NewSimusJ/J_CI_jackknife_mvn_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_jackknife_wald_PP_red, file = paste("NewSimusJ/J_CI_jackknife_wald_PP_red_low_",as.character(l),".rda", sep = ""))
save(computation_time, file = paste("NewSimusJ/J_computation_time_low_",as.character(l),".rda", sep = ""))
save(estimates, file = paste("NewSimusJ/J_estimates_red_low_", as.character(l), ".rda", sep = ""))
save(survival_treatment_estimates, file = paste("NewSimusJ/J_survival_treatment_estimates_low_", as.character(l), ".rda", sep = ""))
save(survival_control_estimates, file = paste("NewSimusJ/J_survival_control_estimates_low_", as.character(l), ".rda", sep = ""))
save(jackknife_SEs, file = paste("NewSimusJ/J_jackknife_SEs_low_", as.character(l), ".rda", sep = ""))
save(bootstrap_mrd, file = paste("NewSimusJ/J_bootstrap_mrd_low_", as.character(l), ".rda", sep = "")) 
save(LEF_outcome_mrd, file = paste("NewSimusJ/J_LEF_outcome_mrd_low_", as.character(l), ".rda", sep = "")) 
save(LEF_both_mrd, file = paste("NewSimusJ/J_LEF_both_mrd_low_", as.character(l), ".rda", sep = "")) 
save(jackknife_wald_mrd, file = paste("NewSimusJ/J_jackknife_wald_mrd_low_", as.character(l), ".rda", sep = "")) 
save(jackknife_mvn_mrd, file = paste("NewSimusJ/J_jackknife_mvn_mrd_low_", as.character(l), ".rda", sep = "")) 
save(sandwich_mrd, file = paste("NewSimusJ/J_sandwich_mrd_low_", as.character(l), ".rda", sep = "")) 
save(coeff_dim, file = paste("NewSimusJ/coeff_dim_low_", as.character(l), ".rda", sep = "")) 
save(bootstrap_nas, file = paste("NewSimusJ/bootstrap_nas_low_", as.character(l), ".rda", sep = "")) 
save(jackknife_nas, file = paste("NewSimusJ/jackknife_nas_low_", as.character(l), ".rda", sep = "")) 
