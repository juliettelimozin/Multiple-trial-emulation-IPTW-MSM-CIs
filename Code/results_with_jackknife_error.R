...
load("~/rds/hpc-work/Project1/NewSimusJ_error/J_sandwich_SE.rda")
load("~/rds/hpc-work/Project1/NewSimusJ_error/J_bootstrap_SE.rda")
load("~/rds/hpc-work/Project1/NewSimusJ_error/J_LEF_outcome_SE.rda")
load("~/rds/hpc-work/Project1/NewSimusJ_error/J_LEF_both_SE.rda")
load("~/rds/hpc-work/Project1/NewSimusJ_error/J_jackknife_mvn_SE.rda")

for (i in 1:27){
  for (j in 1:3){
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_bootstrap_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_jackknife_mvn_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_jackknife_wald_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_LEF_outcome_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_LEF_both_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_CI_sandwich_PP_red_",outcomes[j],'_', i, ".rda"))
    load(paste0("~/rds/hpc-work/Project1/NewSimusJ_error/J_computation_time_",outcomes[j],'_', i, ".rda"))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/J_estimates_red_',outcomes[j],'_',i, '.rda'))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/J_survival_treatment_estimates_',outcomes[j],'_',i, '.rda'))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/J_survival_control_estimates_',outcomes[j],'_',i, '.rda'))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/J_jackknife_SEs_',outcomes[j],'_',i, '.rda'))
...
##############
pivot_coverage_ind_old <- array(0,dim = c(6,5,27,3))
      ...
      for (l in 1:3){
        ...
        if (is.na(bootstrap[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - bootstrap[k,2,i,j,l] <=true_value_red[k,scenario, l])
            ...
            pivot_coverage_ind_old[1,k,j,l] <- pivot_coverage_ind_old[1,k,j,l] + 1
          }
        }
        ...
        if (is.na(LEF_outcome[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - LEF_outcome[k,2,i,j,l] <= true_value_red[k,scenario, l])
            ...
            pivot_coverage_ind_old[2,k,j,l] <- pivot_coverage_ind_old[2,k,j,l] + 1
          }
        }
        ...
        if (is.na(LEF_both[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - LEF_both[k,2,i,j,l] <= true_value_red[k,scenario, l])
            ...
            pivot_coverage_ind_old[3,k,j,l] <- pivot_coverage_ind_old[3,k,j,l] + 1
          }
        }
        ...
        if (all(is.na(sandwich[k,1,i,j,l])) == F){
          ...
          if (all(sandwich[k,1,i,j,l] <= true_value_red[k,scenario, l])
              & all(sandwich[k,2,i,j,l] >= true_value_red[k,scenario, l])){
            pivot_coverage_ind_old[4,k,j,l]<- pivot_coverage_ind_old[4,k,j,l]+ 1
          }
        }
        if (all(is.na(jackknife_mvn[k,1,i,j,l])) == F){
          ...
          if (all(jackknife_mvn[k,1,i,j,l] <= true_value_red[k,scenario, l])
            ...
            pivot_coverage_ind_old[5,k,j,l]<- pivot_coverage_ind_old[5,k,j,l]+ 1
          }
        }
        if (all(is.na(jackknife_wald[k,1,i,j,l])) == F){
          ...
          if (all(jackknife_wald[k,1,i,j,l] <= true_value_red[k,scenario, l])
            ...
            pivot_coverage_ind_old[6,k,j,l]<- pivot_coverage_ind_old[6,k,j,l]+ 1
          }
        }
      }
    }
...
pivot_coverage_ind_old <- pivot_coverage_ind_old/pivot_success

bias_elim_pivot_coverage_ind_old <- array(0,dim = c(6,5,27,3))
      ...
      for (l in 1:3){
        ...
        if (is.na(bootstrap[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - bootstrap[k,2,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
            ...
            bias_elim_pivot_coverage_ind_old[1,k,j,l] <- bias_elim_pivot_coverage_ind_old[1,k,j,l] + 1
          }
        }
        ...
        if (is.na(LEF_outcome[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - LEF_outcome[k,2,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
            ...
            bias_elim_pivot_coverage_ind_old[2,k,j,l] <- bias_elim_pivot_coverage_ind_old[2,k,j,l] + 1
          }
        }
        ...
        if (is.na(LEF_both[k,1,i,j,l]) == F){
          ...
          if (all(2*est[k,i,j,l] - LEF_both[k,2,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
            ...
            bias_elim_pivot_coverage_ind_old[3,k,j,l] <- bias_elim_pivot_coverage_ind_old[3,k,j,l] + 1
          }
        }
        ...
        if (all(is.na(sandwich[k,1,i,j,l])) == F){
          ...
          if (all(sandwich[k,1,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
              & all(sandwich[k,2,i,j,l] >= bias_point[k,j,l] +true_value_red[k,scenario, l])){
            bias_elim_pivot_coverage_ind_old[4,k,j,l]<- bias_elim_pivot_coverage_ind_old[4,k,j,l]+ 1
          }
        }
        if (all(is.na(jackknife_mvn[k,1,i,j,l])) == F){
          ...
          if (all(jackknife_mvn[k,1,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
            ...
            bias_elim_pivot_coverage_ind_old[5,k,j,l]<- bias_elim_pivot_coverage_ind_old[5,k,j,l]+ 1
          }
        }
        if (all(is.na(jackknife_wald[k,1,i,j,l])) == F){
          ...
          if (all(jackknife_wald[k,1,i,j,l] <= bias_point[k,j,l] +true_value_red[k,scenario, l])
            ...
            bias_elim_pivot_coverage_ind_old[6,k,j,l]<- bias_elim_pivot_coverage_ind_old[6,k,j,l]+ 1
          }
        }
      }
    }
...
bias_elim_pivot_coverage_ind_old <- bias_elim_pivot_coverage_ind_old/bias_elim_pivot_success
...
coverage_low <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,1], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,1], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,1], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,1], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,1], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,1], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,1], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,1], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,1], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,1], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,1], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,1], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
coverage_med <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,2], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,2], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,2], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,2], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,2], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,2], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,2], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,2], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,2], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,2], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,2], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,2], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
coverage_high <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,3], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[1,,i,3], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,3], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[2,,i,3], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,3], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[3,,i,3], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,3], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,3], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[4,,i,3], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,3], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[5,,i,3], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,3], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = pivot_coverage_ind_old[6,,i,3], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
coverage_low <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,1], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,1], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,1], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,1], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,1], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,1], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,1], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,1], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,1], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,1], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,1], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,1], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
coverage_med <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,2], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,2], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,2], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,2], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,2], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,2], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,2], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,2], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,2], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,2], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,2], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,2], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
coverage_high <-  lapply(1:27, function(i){
  ggplot() +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,3], colour = "Bootstrap")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[1,,i,3], colour = "Bootstrap")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,3], colour = "LEF outcome")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[2,,i,3], colour = "LEF outcome")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,3], colour = "LEF both")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[3,,i,3], colour = "LEF both")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,3], colour = "Sandwich")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[4,,i,3], colour = "Sandwich")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,3], colour = "Jackknife MVN")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[5,,i,3], colour = "Jackknife MVN")) +
    geom_line(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,3], colour = "Jackknife Wald")) +
    geom_point(aes(x = 0:4, y = bias_elim_pivot_coverage_ind_old[6,,i,3], colour = "Jackknife Wald")) +
    scale_color_manual(name = "CI type", values = c("Bootstrap"= "red", "Sandwich" = "blue",
                                                    "LEF outcome" = "green", "LEF both" = "purple",
                                                    "Jackknife MVN" = 'orange',"Jackknife Wald" = 'deepskyblue' )) +
    geom_hline(yintercept = 0.95, linetype = "dashed") +
...
for (i in 1:27){
  for (j in 1:3){
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/coeff_dim_',outcomes[j],'_',i, '.rda'))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/bootstrap_nas_',outcomes[j],'_',i, '.rda'))
    load(paste0('~/rds/hpc-work/Project1/NewSimusJ_error/jackknife_nas_',outcomes[j],'_',i, '.rda'))
...
for (i in 1:27){
  for (j in 1:3){
    MC_SE_pivot[,,i,j] <- sqrt((pivot_coverage_ind_old[,,i,j]*(1-pivot_coverage_ind_old[,,i,j]))/iters)
  }
}
