...
p13 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_coefs[,1], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_coefs[,1], colour = "Full model")) +
...
p14 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_coefs[,5], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_coefs[,5], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
  ...
  theme(plot.title = element_text(size=10))
p15 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_coefs[,9], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_coefs[,9], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
...
p16 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_treat[,1], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_treat[,1], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
  ...
  theme(plot.title = element_text(size=10))
p17 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_treat[,5], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_treat[,5], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
  ...
  theme(plot.title = element_text(size=10))
p18 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_treat[,9], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_treat[,9], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
...
p19 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_size[,1], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_size[,1], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
  ...
  theme(plot.title = element_text(size=10))
p20 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_size[,4], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_size[,4], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
  ...
  theme(plot.title = element_text(size=10))
p21 <- ggplot()+
  geom_line(aes(x = 0:4, y = bias_point_size[,6], colour = "Full model")) +
  geom_point(aes(x = 0:4, y = bias_point_size[,6], colour = "Full model")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Model type", values = c("Full model"= "green", "Simple model" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Empirical bias",
