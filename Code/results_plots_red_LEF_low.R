...
for (i in 1:9){
  load(paste0("HPC output/CI_bootstrap_coefs_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_LEF_outcome_coefs_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_LEF_both_coefs_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_sandwich_coefs_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/computation_time_coefs_low_", i, ".rda"))
  
  load(paste0("HPC output/CI_bootstrap_treat_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_LEF_outcome_treat_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_LEF_both_treat_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/CI_sandwich_treat_PP_red_low_", i, ".rda"))
  load(paste0("HPC output/computation_time_treat_low_", i, ".rda"))
  ...
  #load(paste0("HPC output/CI_bootstrap_coefs_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_LEF_outcome_coefs_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_LEF_both_coefs_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_sandwich_coefs_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/computation_time_coefs_big_low_", i, ".rda"))
  
  #load(paste0("HPC output/CI_bootstrap_treat_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_LEF_outcome_treat_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_LEF_both_treat_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/CI_sandwich_treat_PP_red_big_low_", i, ".rda"))
  #load(paste0("HPC output/computation_time_treat_big_low_", i, ".rda"))
...
#for (i in 1:7){
  #load(paste0("HPC output/CI_bootstrap_size_PP_red_low_", sizes[i], ".rda"))
  #load(paste0("HPC output/CI_LEF_outcome_size_PP_red_low_", sizes[i], ".rda"))
  #load(paste0("HPC output/CI_LEF_both_size_PP_red_low_", sizes[i], ".rda"))
  #load(paste0("HPC output/CI_sandwich_size_PP_red_low_", sizes[i], ".rda"))
