...
save(CI_bootstrap_size_PP_red, file = paste("CI_bootstrap_size_PP_red_",as.character(l),".rda", sep = ""))
save(CI_sandwich_size_PP_red, file = paste("CI_sandwich_size_PP_red_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_size_PP_red, file = paste("CI_LEF_outcome_size_PP_red_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_size_PP_red, file = paste("CI_LEF_both_size_PP_red_",as.character(l),".rda", sep = ""))
save(computation_time_size, file = paste("computation_time_size_",as.character(l),".rda", sep = ""))
