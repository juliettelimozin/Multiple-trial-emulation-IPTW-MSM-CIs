...
differences_200boot_KM <- rbind(cbind(0:4,round(true_value_boot_200[,,1] - true_value_red[,,1], digits = 3)),
                                cbind(0:4,round(true_value_boot_200[,,2] - true_value_red[,,2], digits = 3)),
                                cbind(0:4,round(true_value_boot_200[,,3] - true_value_red[,,3], digits = 3)))
print(xtable(differences_200boot_KM, type = 'latex', digits = c(0,0,3,3,3,3,3,3,3,3,3)), include.rownames = F)

load('true_value_red_pseudo_true_boot_500it.rda')
true_value_boot_500 <- true_value_boot

differences_500boot_KM <- rbind(cbind(0:4,round(true_value_boot_500[,,1] - true_value_red[,,1], digits = 3)),
                                cbind(0:4,round(true_value_boot_500[,,2] - true_value_red[,,2], digits = 3)),
                                cbind(0:4,round(true_value_boot_500[,,3] - true_value_red[,,3], digits = 3)))
print(xtable(differences_500boot_KM, type = 'latex', digits = c(0,0,3,3,3,3,3,3,3,3,3)), include.rownames = F)
