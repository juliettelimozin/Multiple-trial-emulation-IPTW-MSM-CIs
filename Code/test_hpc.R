...
load("/Users/juliette/Documents/MPhil PHS 21-22/MPhil-dissertation/Code/HPC output/CI_bootstrap_treat_1.rda")

simdata_censored<-DATA_GEN_censored(1000, 10, treat_prev = 0.1) 
...
predicted_probas_ITT$survival_difference_lb <- CI_bootstrap_treat[,1,1]
predicted_probas_ITT$survival_difference_ub <- CI_bootstrap_treat[,2,1]
...
load("/Users/juliette/Documents/MPhil PHS 21-22/MPhil-dissertation/Code/HPC output/CI_sandwich_treat_1.rda")
predicted_probas_ITT$survival_difference_lb <- CI_sandwich_treat[,1,1]
predicted_probas_ITT$survival_difference_ub <- CI_sandwich_treat[,2,1]
