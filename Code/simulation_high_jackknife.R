...
save(CI_bootstrap_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_bootstrap_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_sandwich_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_sandwich_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_LEF_outcome_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_LEF_both_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_jackknife_mvn_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_jackknife_mvn_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_jackknife_wald_PP_red, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_CI_jackknife_wald_PP_red_high_",as.character(l),".rda", sep = ""))
save(computation_time, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_computation_time_high_",as.character(l),".rda", sep = ""))
save(estimates, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_estimates_red_high_", as.character(l), ".rda", sep = ""))
save(survival_treatment_estimates, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_survival_treatment_estimates_high_", as.character(l), ".rda", sep = ""))
save(survival_control_estimates, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_survival_control_estimates_high_", as.character(l), ".rda", sep = ""))
save(jackknife_SEs, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_jackknife_SEs_high_", as.character(l), ".rda", sep = ""))
save(bootstrap_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_bootstrap_mrd_high_", as.character(l), ".rda", sep = "")) 
save(LEF_outcome_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_LEF_outcome_mrd_high_", as.character(l), ".rda", sep = "")) 
save(LEF_both_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_LEF_both_mrd_high_", as.character(l), ".rda", sep = "")) 
save(jackknife_wald_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_jackknife_wald_mrd_high_", as.character(l), ".rda", sep = "")) 
save(jackknife_mvn_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_jackknife_mvn_mrd_high_", as.character(l), ".rda", sep = "")) 
save(sandwich_mrd, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/J_sandwich_mrd_high_", as.character(l), ".rda", sep = "")) 
save(coeff_dim, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/coeff_dim_high_", as.character(l), ".rda", sep = "")) 
save(bootstrap_nas, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/bootstrap_nas_high_", as.character(l), ".rda", sep = "")) 
save(jackknife_nas, file = paste("~/rds/hpc-work/Project1/NewSimusJ_correct_seeding_fixed/jackknife_nas_high_", as.character(l), ".rda", sep = "")) 
