...
save(CI_bootstrap_PP_red, file = paste("CI_bootstrap_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_sandwich_PP_red, file = paste("CI_sandwich_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_PP_red, file = paste("CI_LEF_outcome_PP_red_low_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_PP_red, file = paste("CI_LEF_both_PP_red_low_",as.character(l),".rda", sep = ""))
save(computation_time, file = paste("computation_time_low_",as.character(l),".rda", sep = ""))
save(estimates, file = paste("estimates_red_low_", as.character(l), ".rda", sep = ""))
