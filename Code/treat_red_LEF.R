...
save(CI_bootstrap_treat_PP_red, file = paste("CI_bootstrap_treat_PP_red_",as.character(l),".rda", sep = ""))
save(CI_sandwich_treat_PP_red, file = paste("CI_sandwich_treat_PP_red_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_treat_PP_red, file = paste("CI_LEF_outcome_treat_PP_red_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_treat_PP_red, file = paste("CI_LEF_both_treat_PP_red_",as.character(l),".rda", sep = ""))
save(computation_time_treat, file = paste("computation_time_treat_",as.character(l),".rda", sep = ""))
