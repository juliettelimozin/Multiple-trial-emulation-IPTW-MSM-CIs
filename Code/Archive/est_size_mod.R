...
for (i in 1:iters){
  ...
  tryCatch({
    ...
    size_PP_mod[,i] <- pull(predicted_probas_PP_sample, survival_difference)
    
  }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
}
save(size_PP_mod, file = paste("size_PP_mod_",as.character(l),".rda", sep = ""))
