...
save(CI_bootstrap_size_PP, file = paste("CI_bootstrap_size_PP_noint_",as.character(l),".rda", sep = ""))
save(CI_sandwich_size_PP, file = paste("CI_sandwich_size_PP_noint_",as.character(l),".rda", sep = ""))
