...
load("HPC output/limit_value_conf_red.rda")
load("HPC output/limit_value_treat_red.rda")
...
for (i in 1:9){
  ...
  load(paste0("HPC output/treat_PP_red_",treat_vals[i],".rda"))
  coefs[,,i] <- coefs_PP_red
  treat[,,i] <- treat_PP_red
}


sizes <- c(2,5,8,10,25,50)
for (i in 1:6){
  load(paste0("HPC output/size_PP_red_",sizes[i],".rda"))
  size[,,i] <- size_PP_red
}
...
limit_bias_point_coefs <- array(,dim = c(5,9))
limit_bias_point_treat <- array(,dim = c(5,9))
limit_bias_point_size <- array(,dim = c(5,6))
...
for (i in 1:9){
  ...
  limit_bias_point_coefs[,i] <- rowMeans(coefs[,,i], na.rm = TRUE) - (limit_value_conf_red[,1,i] - limit_value_conf_red[,2,i])
  limit_bias_point_treat[,i] <- rowMeans(treat[,,i], na.rm = TRUE) - (limit_value_treat_red[,1,i] - limit_value_treat_red[,2,i])
}

for (i in 1:6){
  bias_point_size[,i] <- rowMeans(size[,,i], na.rm = TRUE) - (true_value_conf_red[,1,5] - true_value_conf_red[,2,5])
  limit_bias_point_size[,i] <- rowMeans(size[,,i], na.rm = TRUE) - (limit_value_conf_red[,1,5] - limit_value_conf_red[,2,5])
...
p1 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_coefs[,1]/coefs_sd[,1]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_coefs[,1]/coefs_sd[,1]), colour = "Limiting value")) +
...
p2 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_coefs[,5]/coefs_sd[,5]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_coefs[,5]/coefs_sd[,5]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p3 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_coefs[,9]/coefs_sd[,9]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_coefs[,9]/coefs_sd[,9]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p4 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_treat[,1]/treat_sd[,1]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_treat[,1]/treat_sd[,1]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p5 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_treat[,5]/treat_sd[,5]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_treat[,5]/treat_sd[,5]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p6 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_treat[,9]/treat_sd[,9]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_treat[,9]/treat_sd[,9]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p7 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_size[,1]/size_sd[,1]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_size[,1]/size_sd[,1]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p8 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_size[,4]/size_sd[,4]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_size[,4]/size_sd[,4]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p9 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = abs(limit_bias_point_size[,6]/size_sd[,6]), colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = abs(limit_bias_point_size[,6]/size_sd[,6]), colour = "Limiting value")) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p10 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_coefs[,1], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_coefs[,1], colour = "Limiting value")) +
...
p11 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_coefs[,5], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_coefs[,5], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p12 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_coefs[,9], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_coefs[,9], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias",
...
p13 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_treat[,1], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_treat[,1], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p14 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_treat[,5], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_treat[,5], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p15 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_treat[,9], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_treat[,9], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p16 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_size[,1], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_size[,1], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p17 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_size[,4], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_size[,4], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p18 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_size[,6], colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_size[,6], colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p28 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_coefs[,1]^2 + coefs_sd[,1]^2, colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_coefs[,1]^2 + coefs_sd[,1]^2, colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
...
p29 <- ggplot()+
  ...
  geom_line(aes(x = 0:4, y = limit_bias_point_coefs[,5]^2 + coefs_sd[,5]^2, colour = "Limiting value")) +
  geom_point(aes(x = 0:4, y = limit_bias_point_coefs[,5]^2 + coefs_sd[,5]^2, colour = "Limiting value")) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_color_manual(name = "Bias calculation method", values = c("KM curve"= "green", "Limiting value" = "purple")) +
  labs(x = 'Follow up time', 
       y = "Bias to SE ratio",
