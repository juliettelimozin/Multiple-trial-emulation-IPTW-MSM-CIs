...
iters <- 1000
treat_PP_red <- matrix(,nrow = 5, ncol = iters)
...
for (i in 1:iters){
  ...
  tryCatch({
    ...
    treat_PP_red[,i] <- pull(predicted_probas_PP_sample, survival_difference)
    
  }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
}
save(treat_PP_red, file = paste("treat_PP_red_",as.character(l),".rda", sep = ""))
