...
data_direction <- paste("~/rds/hpc-work/models_scenario_high_",l,sep = "")
...
save(CI_bootstrap_PP_red, file = paste("CI_bootstrap_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_sandwich_PP_red, file = paste("CI_sandwich_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_PP_red, file = paste("CI_LEF_outcome_PP_red_high_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_PP_red, file = paste("CI_LEF_both_PP_red_high_",as.character(l),".rda", sep = ""))
save(computation_time, file = paste("computation_time_high_",as.character(l),".rda", sep = ""))
