...
save(CI_bootstrap_coefs_PP_red_big, file = paste("CI_bootstrap_coefs_PP_red_big_",as.character(l),".rda", sep = ""))
save(CI_sandwich_coefs_PP_red_big, file = paste("CI_sandwich_coefs_PP_red_big_",as.character(l),".rda", sep = ""))
save(CI_LEF_outcome_coefs_PP_red_big, file = paste("CI_LEF_outcome_coefs_PP_red_big_",as.character(l),".rda", sep = ""))
save(CI_LEF_both_coefs_PP_red_big, file = paste("CI_LEF_both_coefs_PP_red_big_",as.character(l),".rda", sep = ""))
save(computation_time_coefs_big, file = paste("computation_time_coefs_big_",as.character(l),".rda", sep = ""))
